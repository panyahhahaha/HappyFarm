  ...
  "level-p3": [
    {
      ...
      badgeEmoji: "🥉",
      slides: [
        { text: "🦉 สวัสดีครับเด็กๆ ชั้น ป.3 ที่น่ารักของครูนกฮูก! ยินดีต้อนรับสู่ชั่วโมงศิลปะคณิตศาสตร์เรื่อง **เศษส่วนเบื้องต้น (Introduction to Fractions)** กันนะครับ!<br><br>เศษส่วน (Fractions) ฟังดูเหมือนยากใช่ไหมเอ่ย? จริงๆ แล้วมันง่ายและอร่อยมากครับ! ลองคิดถึง **การแบ่งของหนึ่งชิ้นออกเป็นส่วนย่อยๆ ที่มีขนาดเท่ากันเป๊ะ** เช่น ครูมีพิซซ่ากลมหอมกรุ่นอยู่ 1 ถาด หากครูนำมีดมาตัดแบ่งครึ่งและหั่นอีกครั้ง ได้ทั้งหมด 4 ชิ้นที่กว้างเท่ากัน แต่ละชิ้นเราจะเรียกว่าเป็น เศษหนึ่งส่วนสี่ หรือเขียนแทนด้วยสัญลักษณ์ **1/4** นั่นเองครับ!", visual: "🍕 1/4" },
        ...
        { text: "🎓 **ห้องแนะนำสำหรับคุณพ่อคุณแม่ (Parent Guide) จากครูนกฮูก:**<br><br>• **สิ่งสำคัญที่สุด**: เด็กวัย ป.3 ต้องเข้าใจว่า ทุกชิ้นส่วนที่แบ่งออกมา 'ต้องมีขนาดเท่ากันเป๊ะ' หากแบ่งไม่เท่ากัน (เช่น ตัดแบ่งขนมเค้กชิ้นเล็กชิ้นใหญ่สลับกัน) จะไม่สามารถเขียนแทนด้วยเศษส่วนทางคณิตศาสตร์ได้ครับ<br>• **ข้อพึงระวัง**: เด็กมักคิดว่าตัวเลขส่วนข้างล่างเยอะ ขนาดชิ้นจะใหญ่ขึ้น (เช่น เข้าใจผิดว่า 1/4 ใหญ่กว่า 1/2) ให้เปรียบเทียบเชิงรูปธรรมว่า 'ยิ่งมีคนมาหารมาร่วมแบ่งเยอะขึ้น ขนาดชิ้นพิซซ่าที่ลูกได้รับไปทานก็จะยิ่งเล็กลงนะครับ'" , visual: "👨‍👩‍👧‍👦 คู่มือผู้ปกครอง" }
      ]
,
      postTest: [
