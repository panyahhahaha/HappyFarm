...
window.questionsData = {
  "level-kg": {
    name: "Kindergarten (อนุบาล / อ.1 - อ.3)",
      ...
      { id: "kg_m3", type: "shape", question: "Which picture is a Circle? (รูปไหนคือวงกลม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🔴</span>", explanation: "วงกลม (Circle) มีลักษณะโค้งมนกลมเกลี้ยง ไม่มีเหลี่ยมไม่มีมุม เหมือนรูป 🔴 ครับ!" },
      { id: "kg_m4", type: "shape", question: "Which picture is a Triangle? (รูปไหนคือสามเหลี่ยม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🔺</span>", explanation: "สามเหลี่ยม (Triangle) มี 3 มุมและมี 3 ด้านแหลมๆ ชี้ขึ้นด้านบน เหมือนรูป 🔺 ครับ!" },
      { id: "kg_m5", type: "shape", question: "Which picture is a Square? (รูปไหนคือสี่เหลี่ยม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🟦</span>", explanation: "สี่เหลี่ยม (Square) มี 4 มุมและมี 4 ด้านเท่ากัน เหมือนรูปกล่อง 🟦 ครับ!" },
...
window.lessonsData = {
    "level-kg": [
    {
      ...
      badgeEmoji: "🐰",
      slides: [
        { text: "สวัสดีครับคุณหนูๆ และผู้ปกครอง! ห้อง Pearn rean pean sanook 🦉 ยินดีต้อนรับสู่บทเรียนนับเลข **1 ถึง 5** ไปด้วยกันนะ!<br><br>มาจำหน้าตาและออกเสียงตัวเลขไปพร้อมกันครับ:<br>• **1** (หนึ่ง) | **2** (สอง)<br>• **3** (สาม) | **4** (สี่)<br>• **5** (ห้า)", visual: "<span style='font-size:3.5rem;'>1️⃣ 2️⃣ 3️⃣ 4️⃣ 5️⃣</span>" },
    ...
    },
    {
      ...
      postTest: [
        { question: "Which picture is a Circle? (รูปไหนคือวงกลม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🔴</span>", explanation: "เส้นโค้งมนไม่มีมุมแหลมคือรูปวงกลม (Circle) ครับ!" },
        { question: "Which picture is a Square? (รูปไหนคือสี่เหลี่ยม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🟦</span>", explanation: "มี 4 มุมและ 4 ด้านตรงเท่ากันคือรูปทรงสี่เหลี่ยม (Square) ครับ!" },
        { question: "Which picture is a Triangle? (รูปไหนคือสามเหลี่ยม?)", visual: "<span style='font-size:3.5rem;'>❓</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🔺</span>", explanation: "มี 3 มุมแหลมเหมือนหลังคาจั่วคือรูปทรงสามเหลี่ยม (Triangle) ครับ!" },
        { question: "Which shape matches a coin 🪙? (รูปทรงใดคู่กับเหรียญ 🪙?)", visual: "<span style='font-size:3.5rem;'>🪙</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🔴</span>", explanation: "เงินเหรียญมีลักษณะโค้งมนแบนเรียบ ไม่มีมุมฉาก จึงจับคู่กับวงกลม 🔴 ครับ!" },
        { question: "Which shape matches a box 📦? (รูปทรงใดคู่กับกล่อง 📦?)", visual: "<span style='font-size:3.5rem;'>📦</span>", options: ["<span style='font-size:2rem;'>🔴</span>", "<span style='font-size:2rem;'>🟦</span>", "<span style='font-size:2rem;'>🔺</span>"], answer: "<span style='font-size:2rem;'>🟦</span>", explanation: "กล่องพัสดุมี 4 ด้านเท่ากันและมีมุมฉาก จึงจับคู่กับสี่เหลี่ยม 🟦 ครับ!" }
      ]
    },
    {
      id: "kg_les_phonics",
      ...
      slides: [
        ...
        { text: "ออกเสียงตาม Pearn rean pean sanook นะเด็กๆ:<br><br>• 🅰️ **Letter A** ➔ ออกเสียงสั้นว่า **'แอะ'** (ae) เช่น A-A-Apple<br>• 🅱️ **Letter B** ➔ ออกเสียงพยัญชนะต้น **'เบอะ'** (be) เช่น B-B-Banana<br>• 🅾️ **Letter C** ➔ ออกเสียงกักเสียง **'เคอะ'** (ke) เช่น C-C-Cat<br>ลองเลียนเสียงตามจังหวะเสียงสนุกๆ ดูนะ!", visual: "<span style='font-size:3.5rem;'>🍎 🍌 🐱</span>" },
  ...
  "level-p3": [
    {
      ...
      badgeEmoji: "🥉",
      slides: [
        { text: "🦉 ยินดีต้อนรับเด็กๆ ชั้น ป.3 เข้าสู่ห้อง Pearn rean pean sanook! วันนี้เรามาเรียนเรื่อง **เศษส่วนเบื้องต้น (Introduction to Fractions)** กันนะครับ!<br><br>เศษส่วน (Fractions) ฟังดูเหมือนยากใช่ไหมเอ่ย? จริงๆ แล้วมันง่ายและอร่อยมากครับ! ลองคิดถึง **การแบ่งของหนึ่งชิ้นออกเป็นส่วนย่อยๆ ที่มีขนาดเท่ากันเป๊ะ** เช่น ครูมีพิซซ่ากลมหอมกรุ่นอยู่ 1 ถาด หากครูนำมีดมาตัดแบ่งครึ่งและหั่นอีกครั้ง ได้ทั้งหมด 4 ชิ้นที่กว้างเท่ากัน แต่ละชิ้นเราจะเรียกว่าเป็น เศษหนึ่งส่วนสี่ หรือเขียนแทนด้วยสัญลักษณ์ **1/4** นั่นเองครับ!", visual: "🍕 1/4" },
        { text: "🌟 **มาเข้าใจโครงสร้างของตัวเลขเศษส่วนกันนะเด็กๆ:**<br><br>ตัวเลขเศษส่วนจะเขียนซ้อนกันสองชั้นเหมือนตึก 2 ชั้นครับ:<br>• 👆 **ตัวเลขชั้นบน (ตัวเศษ - Numerator)**: บอกจำนวนชิ้นส่วนย่อยที่เราหยิบไปกิน สนใจ หรือเลือกไว้ระบายสี<br>• 👇 **ตัวเลขชั้นล่าง (ตัวส่วน - Denominator)**: บอกจำนวนชิ้นทั้งหมดที่เราหั่นแบ่งออกมาเท่าๆ กันตั้งแต่แรกสุด<br><br>เช่น พิซซ่าถาดเดิมตัดแบ่ง 4 ชิ้น (ตัวส่วน = 4) ถ้ามีคนหยิบกินไป 1 ชิ้น จะเหลือพิซซ่าอยู่ 3 ชิ้น (ตัวเศษ = 3) คิดเป็นเศษส่วนได้ว่า **3/4** (อ่านว่า เศษสามส่วนสี่) ครับ!", visual: "<img src='assets/fraction_illustration.jpg' style='max-height: 120px; border-radius: 8px; margin: 8px 0;' alt='Fraction Illustration'>" },
        { text: "🎓 **คู่มือสำหรับผู้ปกครอง (Parent Guide) จาก Pearn rean pean sanook:**<br><br>• **สิ่งสำคัญที่สุด**: เด็กวัย ป.3 ต้องเข้าใจว่า ทุกชิ้นส่วนที่แบ่งออกมา 'ต้องมีขนาดเท่ากันเป๊ะ' หากแบ่งไม่เท่ากัน (เช่น ตัดแบ่งขนมเค้กชิ้นเล็กชิ้นใหญ่สลับกัน) จะไม่สามารถเขียนแทนด้วยเศษส่วนทางคณิตศาสตร์ได้ครับ<br>• **ข้อพึงระวัง**: เด็กมักคิดว่าตัวเลขส่วนข้างล่างเยอะ ขนาดชิ้นจะใหญ่ขึ้น (เช่น เข้าใจผิดว่า 1/4 ใหญ่กว่า 1/2) ให้เปรียบเทียบเชิงรูปธรรมว่า 'ยิ่งมีคนมาหารมาร่วมแบ่งเยอะขึ้น ขนาดชิ้นพิซซ่าที่ลูกได้รับไปทานก็จะยิ่งเล็กลงนะครับ'" , visual: "👨‍👩‍👧‍👦 คู่มือผู้ปกครอง" }
      ]
,
      postTest: [
  ...
  "level-p4": [
    {
      ...
      badgeEmoji: "🔎",
      slides: [
        { text: "🦉 สวัสดีครับพี่ๆ ป.4 บทเรียนวันนี้คือ **ทศนิยม (Decimals)** แสนสนุกครับ!<br><br>ทศนิยมเป็นการเขียนตัวเลขอีกรูปแบบหนึ่งนอกจากเศษส่วน เพื่อแสดงปริมาณหรือสิ่งของที่ **'ไม่เต็มหนึ่งหน่วย'** หรือมีค่าน้อยกว่า 1 ชิ้นเต็ม โดยใช้เครื่องหมาย **'จุดทศนิยม'** คั่นแยกฝั่งจำนวนเต็ม<br>เช่น เหรียญสลึงมีค่า 0.25 บาท หรือ ความยาวแท่งดินสอ 1.5 เซนติเมตร", visual: "0.5 ➔ 1/2" },
        { text: "การอ่านและแบ่งตำแหน่งทศนิยม:<br>• **จุดทศนิยม**: ตัวแยกจำนวนเต็มด้านซ้ายมือ และเศษทศนิยมด้านขวามือ<br>• **ตำแหน่งที่ 1 หลังจุด**: เรียกว่า **หลักส่วนสิบ** (Tenths) หมายถึงหารด้วย 10<br>• **ตำแหน่งที่ 2 หลังจุด**: เรียกว่า **หลักส่วนร้อย** (Hundredths) หมายถึงหารด้วย 100<br><br>ตัวอย่าง: **0.75** (อ่านออกเสียงว่า ศูนย์-จุด-เจ็ด-ห้า) หมายถึงมี 75 ส่วนจากทั้งหมด 100 ส่วนเท่าๆ กันในหนึ่งหน่วยครับ!", visual: "<img src='assets/decimal_illustration.jpg' style='max-height: 120px; border-radius: 8px; margin: 8px 0;' alt='Decimal Illustration'>" },
        { text: "🎓 **คู่มือสำหรับผู้ปกครอง (Parent Guide) จาก Pearn rean pean sanook:**<br><br>• **วิธีสอนที่ง่ายที่สุด**: ใช้เหรียญสตางค์จริงมาอธิบายความสัมพันธ์ เช่น นำเหรียญ 25 สตางค์ (0.25 บาท) สี่เหรียญมารวมกัน จะได้ 1.00 บาทเต็ม เพื่อให้เด็กเข้าใจมิติเชิงปริมาณ<br>• **จุดที่ต้องระวังเป็นพิเศษ**: เด็ก ป.4 มักเข้าใจสับสนว่าทศนิยมหลายหลักมีค่ามากกว่าเสมอ เช่น คิดว่า 0.45 มีค่ามากกว่า 0.5 (ความจริง 0.5 = 0.50 ซึ่งมีค่ามากกว่า 0.45) ให้แนะนำเด็กเปรียบเทียบเลขทีละหลักจากหลังจุดเป็นหลักแรกครับ", visual: "👨‍👩‍👧‍👦 คู่มือผู้ปกครอง" }
      ]
,
      postTest: [
  ...
  "level-p5": [
    {
      ...
      badgeEmoji: "📐",
      slides: [
        { text: "🦉 ยินดีต้อนรับพี่ๆ ป.5! วันนี้ห้อง Pearn rean pean sanook ชวนมาหา **ปริมาตรของรูปทรงสี่เหลี่ยมมุมฉาก (Volume of Cuboids)** กันอย่างละเอียดนะกลไกปริมาตรคือความจุ of พื้นที่ภายในวัตถุสามมิติ (เช่น กล่องสี่เหลี่ยม หรือสระน้ำ)<br><br>ต่างจากพื้นที่แบนๆ สองมิติ (กว้าง x ยาว) เพราะความจุนี้มีตัวแปร **ความสูงหรือความลึก (Height/Depth)** เพิ่มเติมเข้ามา ทำให้มี 3 มิติ ได้แก่ กว้าง, ยาว และสูงครับ", visual: "Volume = W x L x H" },
        { text: "สูตรคำนวณอย่างเป็นทางการ:<br>📈 **ปริมาตร = กว้าง (Width) x ยาว (Length) x สูง (Height)**<br><br>ขั้นตอนการคำนวณในชีวิตจริง (กล่องพัสดุกว้าง 2 ซม., ยาว 5 ซม., สูง 3 ซม.):<br>• **ขั้นที่ 1 (หาพื้นที่ฐานสองมิติ)**: นำ กว้าง x ยาว ➔ 2 x 5 = **10 ตารางเซนติเมตร**<br>• **ขั้นที่ 2 (คำนวณความจุสามมิติ)**: นำพื้นที่ฐานคูณด้วยความสูงกล่อง ➔ 10 x 3 = **30 ลูกบาศก์เซนติเมตร** (Cubic Centimeter)<br><br>*หมายเหตุ: หน่วยปริมาตรจะมีคำว่า 'ลูกบาศก์' เสมอ เพราะเกิดจากการนำหน่วยความยาวคูณกันสามครั้งนั่นเองครับ*", visual: "<img src='assets/volume_illustration.jpg' style='max-height: 120px; border-radius: 8px; margin: 8px 0;' alt='Volume Illustration'>" },
        { text: "🎓 **คู่มือสำหรับผู้ปกครอง (Parent Guide) จาก Pearn rean pean sanook:**<br><br>• **เป้าหมาย**: เด็กต้องแยกแยะและเชื่อมโยงหน่วย ตาราง (พื้นที่ราบ) กับ ลูกบาศก์ (ความจุ 3 มิติ) ได้อย่างเข้าใจ<br>• **วิธีสอน**: นำกล่องนมยูเอชทีหรือกล่องของเล่นเปล่ามาชี้มิติทั้งสามให้เด็กเห็นเด่นชัด (กว้างด้านขวาง, ยาวด้านลึก, สูงแนวตั้ง) แล้วลองใช้ไม้บรรทัดวัดความยาวจริงมาคำนวณไปด้วยกัน เพื่อเสริมสร้างประสบการณ์จริง<br>• **ระวัง**: เด็กมักสับสนนำความยาวด้านไปบวกกันแทนที่จะคูณกัน หรือลืมคูณส่วนสูง ให้ช่วยคอยตรวจคำตอบสม่ำเสมอครับ", visual: "👨‍👩‍👧‍👦 คู่มือผู้ปกครอง" }
      ]
,
      postTest: [
  ...
  "level-p6": [
    {
      ...
      badgeEmoji: "🏆",
      slides: [
        { text: "🦉 ยินดีต้อนรับนักเรียนชั้น ป.6 ทุกคนเข้าสู่ห้อง Pearn rean pean sanook แสนสนุกนะครับ วันนี้เราจะพามาเจาะลึกวิเคราะห์เรื่อง **ห.ร.ม. (หารร่วมมาก)** และ **ค.ร.น. (คูณร่วมน้อย)** กันแบบลึกซึ้ง เข้าใจง่าย เหมือนมีติวเตอร์ไปนั่งสอนอยู่ข้างๆ เลยครับ!<br><br>🌟 **มาลองจินตนาการเรื่องราวในชีวิตจริงกันก่อนนะ:**<br>1️⃣ **ห.ร.ม. (G.C.D.)**: สมมติเด็กๆ มีส้ม 8 ผล และแอปเปิ้ล 12 ผล อยากจัดใส่ตะกร้าแจกเพื่อนๆ โดยให้แต่ละตะกร้ามีผลไม้มากที่สุดชนิดเดียวกัน ไม่ผสมกัน และห้ามเหลือเศษเลย! เลขที่ช่วยเราหาจำนวนตะกร้าที่มากที่สุดคือ ห.ร.ม. ครับ! มันคือ **'ตัวหารร่วมที่ใหญ่ที่สุด'** ที่ไปหารเลขทุกตัวลงตัว<br>2️⃣ **ค.ร.น. (L.C.M.)**: สมมติมีกบสองตัว ตัวแรกกระโดดทีละ 8 ซม. ตัวที่สองกระโดดทีละ 12 ซม. ถ้าเริ่มที่จุดเดียวกัน ทั้งคู่จะกระโดดมาเหยียบตรงจุดเดียวกันเป็นครั้งแรกที่ระยะกี่ ซม.? เลขที่จะบอกจุดนัดพบนี้คือ ค.ร.น. ครับ! มันคือ **'ตัวคูณร่วมที่น้อยที่สุด'** ที่ตัวเลขทุกตัวไปหารมันได้ลงตัวพอดีครับ", visual: "ห.ร.ม. & ค.ร.น." },
        { text: "🌟 **มาดูวิธีหาคำตอบแบบจับมือทำทีละขั้นตอนกันเลยครับเด็กๆ! (ตัวอย่าง: เลข 8 และ 12)**<br><br>🧩 **วิธีที่ 1: วิธีแจกแจง (ค่อยๆ หาตัวประกอบและพหุคูณ)**<br>• **หา ห.ร.ม.**:<br>&nbsp;&nbsp;- มาช่วยหาเลขที่หาร 8 ลงตัวกันครับ ➔ มี **1, 2, 4, 8**<br>&nbsp;&nbsp;- เลขที่หาร 12 ลงตัว ➔ มี **1, 2, 3, 4, 6, 12**<br>&nbsp;&nbsp;- ตัวเลขที่หารลงตัวเหมือนกัน (ตัวหารร่วม) คือ 1, 2 และ **4** ➔ ตัวที่มากที่สุดคือ **4** ดังภาพครับ!<br>• **หา ค.ร.น.**:<br>&nbsp;&nbsp;- ท่องสูตรคูณแม่ 8 ไปพร้อมกันนะ ➔ 8, 16, **24**, 32, 40...<br>&nbsp;&nbsp;- ท่องสูตรคูณแม่ 12 ➔ 12, **24**, 36, 48...<br>&nbsp;&nbsp;- ตัวคูณร่วมที่พบเป็นตัวแรกและน้อยที่สุดคือ **24** ครับ!<br><br>📊 **วิธีที่ 2: วิธีตั้งหารสั้น (Pearn rean pean sanook แนะนำวิธีนี้ รวดเร็วที่สุด!)**<br>&nbsp;&nbsp;1. เขียนตั้งหารสั้น: 8 และ 12<br>&nbsp;&nbsp;2. นำตัวเลขที่หารร่วมทั้งคู่ลงตัวมาตั้งหาร เช่น นำ **4** มาหาร ➔ ผลหารบรรทัดล่างคือ 2 และ 3 (หารต่อไม่ได้แล้ว)<br>&nbsp;&nbsp;• **ห.ร.ม.** = ตัวหารด้านหน้าเดี่ยวๆ = **4**<br>&nbsp;&nbsp;• **ค.ร.น.** = คูณตัวเลขเป็นรูปตัว L (หน้าคูณล่าง) ➔ 4 x 2 x 3 = **24** เก่งมากครับ!", visual: "<img src='assets/gcd_lcm_illustration.jpg' style='max-height: 120px; border-radius: 8px; margin: 8px 0;' alt='G.C.D & L.C.M Illustration'>" },
        { text: "🎓 **คู่มือสำหรับผู้ปกครอง (Parent Guide) จาก Pearn rean pean sanook:**<br><br>• **เทคนิคการจดจำหลักคิดให้ลูก**:<br>&nbsp;&nbsp;- **ห.ร.ม. = หาเพื่อแบ่งกลุ่ม** (เน้นหารตัวเลขให้ได้ขนาดชิ้นใหญ่ที่สุดเท่าๆ กันโดยไม่ปะปน)<br>&nbsp;&nbsp;- **ค.ร.น. = หาจุดนัดพบเวลา** (เน้นพหุคูณค่าน้อยที่สุดที่จะวนมาเจอกันพร้อมกันอีกครั้ง)<br>• **คำแนะนำในการฝึกฝน**: เมื่อลูกใช้วิธีตั้งหารสั้น ให้สอนเขาเขียนวงกลมหรือตีกรอบรูปตัวอักษร **'L'** ล้อมรอบตัวเลขด้านหน้าและด้านล่าง เพื่อนำมารวมคูณกันหา ค.ร.น. จะช่วยให้จดจำภาพเชิงรูปธรรมและไม่มีทางทำสับสนระหว่าง ห.ร.ม. กับ ค.ร.น. แน่นอนครับคุณพ่อคุณแม่", visual: "👨‍👩‍👧‍👦 คู่มือผู้ปกครอง" }
      ]
,
      postTest: [
